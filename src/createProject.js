...
(() => {
  ...
  function openProjectForm() {
    const CreateElements = (() => {
      // divs
      const formWrapper = {
        element: document.createElement("div"), // blocks input
      ...
      const elementsArray = [
        formWrapper,
        formContainer,
        projectForm, // because attributes
        textLabel,
        textInput,
        submitFormImg,
        submitForm,
    ...
    (() => {
      ...
      CreateElements.submitForm.element.appendChild(
        CreateElements.submitFormImg.element
      );
      CreateElements.cancelForm.element.appendChild(
        CreateElements.cancelFormImg.element
      );
      CreateElements.projectForm.element.append(
        CreateElements.textLabel.element,
    ...
    (() => {
      ...
      CreateElements.formWrapper.element.appendChild(
        CreateElements.formContainer.element
      );
      CreateElements.formContainer.element.appendChild(
        CreateElements.projectForm.element
      );
    })();

    CreateElements.submitForm.element.addEventListener("click", () => {
      // grabs input
    ...
    CreateElements.cancelForm.element.addEventListener("click", () => {
      // closes pop up
      closeProjectForm();
    });
  }
